...
question_1 = FreeTextQuestion.create!(text: "People in class", topic: group)
question_2 = FreeTextQuestion.create!(text: "Teacher present", topic: group)
question_3 = FreeTextQuestion.create!(text: "Group photo", topic: group)
question_4 = FreeTextQuestion.create!(text: "Any other comments", topic: group)

tools = Topic.create!(name: "Tools")

question_5 = FreeTextQuestion.create(text: "Secateurs", topic: tools)
question_6 = FreeTextQuestion.create(text: "Working", topic: tools)
question_7 = FreeTextQuestion.create(text: "Workshop date", topic: tools)
question_8 = FreeTextQuestion.create(text: "Photo", topic: tools)
question_9 = FreeTextQuestion.create(text: "Any other comments", topic: tools)

overall = Topic.create!(name: "Overall")

question_10 = FreeTextQuestion.create!(text: "Quality of workshop", topic: overall)
question_11 = FreeTextQuestion.create!(text: "Is the workshop finished?", topic: overall)

inputs = Topic.create!(name: "Inputs")

question_12 = FreeTextQuestion.create!(text: "How much compost did you use from your plot?", topic: inputs)
question_13 = FreeTextQuestion.create!(text: "How much fertiliser?", topic: inputs)
question_14 = FreeTextQuestion.create!(text: "Pesticides?", topic: inputs)
question_15 = FreeTextQuestion.create!(text: "Seedlings planted?", topic: inputs)
question_16 = FreeTextQuestion.create!(text: "Rainwater captured?", topic: inputs)
question_17 = FreeTextQuestion.create!(text: "Most coffee trees shaded?", topic: inputs)
question_18 = FreeTextQuestion.create!(text: "Take a photo", topic: inputs)
question_19 = FreeTextQuestion.create!(text: "Any other comments?", topic: inputs)

outputs = Topic.create!(name: "Outputs")

question_20 = FreeTextQuestion.create!(text: "Total harvest?", topic: outputs)
question_21 = FreeTextQuestion.create!(text: "How much grade 1?", topic: outputs)
question_22 = FreeTextQuestion.create!(text: "How much grade 2?", topic: outputs)
question_23 = FreeTextQuestion.create!(text: "How much grade 3?", topic: outputs)
question_24 = FreeTextQuestion.create!(text: "How much grade 4?", topic: outputs)
question_25 = FreeTextQuestion.create!(text: "Total amount sold?", topic: outputs)
question_26 = FreeTextQuestion.create!(text: "Any other comments?", topic: outputs)
...
question_27 = FreeTextQuestion.create!(text: "Air quality in the village", topic: air_quality)
question_28 = FreeTextQuestion.create!(text: "Is the air in the village clean?", topic: air_quality)
question_29 = FreeTextQuestion.create!(text: "Are there any foul odours?", topic: air_quality)
question_30 = FreeTextQuestion.create!(text: "Any other comments", topic: air_quality)

water_quality = Topic.create!(name: "Water quality in the village")

question_31 = FreeTextQuestion.create!(text: "Is the drinking water in the village clean?", topic: water_quality)
question_32 = FreeTextQuestion.create!(text: "Is the stream clean?", topic: water_quality)
question_33 = FreeTextQuestion.create!(text: "Are there any foul odours?", topic: water_quality)
question_34 = FreeTextQuestion.create!(text: "Are there many dead fish in the stream?", topic: water_quality)
question_35 = FreeTextQuestion.create!(text: "Photo", topic: water_quality)
question_36 = FreeTextQuestion.create!(text: "Any other comments", topic: water_quality)

farm = Topic.create!(name: "On %{farmer}'s farm")

question_37 = FreeTextQuestion.create!(text: "Is there soil pollution on %{farmer}'s farm?", topic: farm)
question_38 = FreeTextQuestion.create!(text: "Any signs of water pollution?", topic: farm)
question_39 = FreeTextQuestion.create!(text: "Any signs of air pollution?", topic: farm)
question_40 = FreeTextQuestion.create!(text: "Are there children working?", topic: farm)
question_41 = FreeTextQuestion.create!(text: "Photo", topic: farm)
question_42 = FreeTextQuestion.create!(text: "Any other comments", topic: farm)
